/*
    ...
    2. WITH 절의 코드 블록은 임시로 저장되기 때문에 곧바로 사용해한다. (성능의 향상 기대할 수 없음)
...
--2. 부서별 부서번호, 부서명, 연봉총액을 조회하기(SUBQUERY, JOIN어느것 써도됨) 
-- 1) 부서별 연봉총액 먼저 구하기 -- 연봉총액이 그룹의 목적
...
SELECT MY.DEPARTMENT_ID
  ...
  FROM DEPARTMENTS D INNER JOIN MY_SUBQUERY MY
    ON D.DEPARTMENT_ID = MY.DEPARTEMNT_ID;
