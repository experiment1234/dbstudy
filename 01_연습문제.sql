...
ALTER TABLE BOARD_T MODIFY CONTENT VARCAHR2(4000 BYTE) NULL;
...
ALTER TABLE BORAD_T ADD CONSTRAINT FK_MEMEBER_BOARD FOREIGN KEY(MEM_ID) REFERENCES MEMBER_T(MEM_ID) ON DELETE CASCADE;
