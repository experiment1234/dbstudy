...
ALTER TABLE MEMBER_T ADDRESS VARCHAR2(200 BYTE) NOT NULL;
ALTER TABLE MEMBER_T JOINED_DT DATE;
...
ALTER TABLE MEMBER_T MODIFY MEM_PWD NAME;
-- 6. 회원번호 칼럼에 기본키(PK_MEMBER)를 설정하시오.
CONSTRAINT PK_MOM PRIMARY KEY(NO);
...
ALTER TABLE BORAD_T ADD CONSTRAINT FK_MEMEBER_BOARD FOREIGN KEY(MEM_ID) REFERENCES MEMBER_T(MEM_ID)
-- 12. MEMBER_T 테이블과 BOARD_T 테이블을 모두 삭제하시오.
ALTER TABLE MEMEBER_T BOARD_T ON DELETE CASCADE