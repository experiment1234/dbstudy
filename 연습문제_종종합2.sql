...
CREATE TABLE BOOK_T(
             BOOK_ID    NUMBER(11 BYTE)    NOT NULL
           , BOOK_NAME  VARCHAR2(100 BYTE) NULL
           , PUBLISHER  VARCHAR2(50 BYTE)  NULL
           , PRICE      NUMBER(6 BYTE)     NULL
);

CREATE TABLE CUSTOMER_T(
             CUST_ID    NUMBER(11 BYTE)    NOT NULL
...
CREATE TABLE ORDER_T(
           ...
           , CUST_ID    NUMBER(11 BYTE)    NULL
           , BOOK_ID    NUMBER(11 BYTE)    NULL
           , AMOUNT     NUMBER(2 BYTE)     NULL
           , ORDER_DT   DATE               NULL
);           
...
INSERT INTO BOOK_T(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUES (BOOK_SEQ.NEXTVAL, '1', '축구의 역사', '굿스포츠', '7000');
INSERT INTO BOOK_T(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUES (BOOK_SEQ.NEXTVAL, '2', '축구 아는 여자', '나이스북', '13000');
INSERT INTO BOOK_T(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUES (BOOK_SEQ.NEXTVAL, '3', '축구의 이해', '대한미디어', '22000');
INSERT INTO BOOK_T(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUES (BOOK_SEQ.NEXTVAL, '4', '골프 바이블', '대한미디어', '35000');
INSERT INTO BOOK_T(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUES (BOOK_SEQ.NEXTVAL, '6', '역도 단계별 기술', '굿스포츠', '6000');
INSERT INTO BOOK_T(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUES (BOOK_SEQ.NEXTVAL, '7', '야구의 추억', '이상미디어', '20000');
INSERT INTO BOOK_T(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUES (BOOK_SEQ.NEXTVAL, '8', '야구를 부탁해', '이상미디어', '20000');
